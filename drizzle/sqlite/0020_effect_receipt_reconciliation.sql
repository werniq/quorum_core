...
--> statement-breakpoint
CREATE TABLE `incidents_effect_receipt_new` (
...
--> statement-breakpoint
INSERT INTO `incidents_effect_receipt_new` SELECT * FROM `incidents`;
--> statement-breakpoint
DROP TABLE `incidents`;
--> statement-breakpoint
ALTER TABLE `incidents_effect_receipt_new` RENAME TO `incidents`;
--> statement-breakpoint
